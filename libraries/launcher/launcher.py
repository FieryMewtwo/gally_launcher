...
class gally_launcher:
    ...
    def download_java(self, version=None):
        ...
        if self.version == None:
            ...
            r_version = re.search(r"1\.(?P<version2>[0-9]+)(\.(?P<version3>[0-9]+))?", version)
    ...
    def start(self, assets=True, java=None, console=False, java_argument=None, game_directory=None):
        ...
        if self.access_token:
            logging.debug(command.replace(self.access_token, "xxxxxxxxxx"))
        else:
